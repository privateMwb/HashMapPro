...
inline std::string custom   = "HashMapPro";
inline std::string standard = "std::unordered_map";
...
// section grouping and HashMapPro/std::unordered_map pairing only exist at print
...
// and the % delta (HashMapPro vs std::unordered_map) colorized — red if HashMapPro
